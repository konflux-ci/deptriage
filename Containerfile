FROM registry.access.redhat.com/ubi10/go-toolset:10.2-1789630856 AS builder
...
FROM registry.access.redhat.com/ubi10/go-toolset:10.2-1789630856 AS tools

USER root
ENV GOPATH=/tmp/go
RUN go install golang.org/x/vuln/cmd/govulncheck@latest

FROM registry.access.redhat.com/ubi10/go-toolset:10.2-1789630856
